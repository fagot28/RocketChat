package chat.rocket.luk.authentication.ui
...
import chat.rocket.luk.authentication.domain.model.getLoginDeepLinkInfo
import chat.rocket.luk.authentication.presentation.AuthenticationPresenter
...
class AuthenticationActivity : AppCompatActivity(), HasSupportFragmentInjector {
    ...
    private fun showOnBoardingFragment() {
        addFragment(
            ...
            chat.rocket.luk.authentication.onboarding.ui.newInstance()
        }
    }
