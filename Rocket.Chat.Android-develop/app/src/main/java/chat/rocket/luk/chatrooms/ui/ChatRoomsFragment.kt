package chat.rocket.luk.chatrooms.ui
...
import chat.rocket.luk.chatrooms.adapter.RoomsAdapter
import chat.rocket.luk.chatrooms.presentation.ChatRoomsPresenter
import chat.rocket.luk.chatrooms.presentation.ChatRoomsView
import chat.rocket.luk.chatrooms.viewmodel.ChatRoomsViewModel
import chat.rocket.luk.chatrooms.viewmodel.ChatRoomsViewModelFactory
import chat.rocket.luk.chatrooms.viewmodel.LoadingState
import chat.rocket.luk.chatrooms.viewmodel.Query
...
import chat.rocket.luk.util.extension.onQueryTextListener
import chat.rocket.luk.util.extensions.ifNotNullNotEmpty
...
import chat.rocket.luk.widget.DividerItemDecoration
    ...
    private fun setupListeners() {
        text_server_name.setOnClickListener {
            ServersBottomSheetFragment().show(
                ...
                chat.rocket.luk.servers.ui.TAG
            )
        }
        ...
        text_sort_by.setOnClickListener {
            SortingAndGroupingBottomSheetFragment().show(
                activity?.supportFragmentManager,
                chat.rocket.luk.sortingandgrouping.ui.TAG
            )
        }
